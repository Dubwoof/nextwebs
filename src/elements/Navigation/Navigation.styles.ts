export const styles = {
    // todo: slate-700 should be a global variable
    nav: `fixed h-12 md:h-20 z-50 left-0 top-0 flex w-full justify-between content-center bg-gradient-to-b from-slate-700 backdrop-blur-2xl`,
