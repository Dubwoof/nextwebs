        ...
        <NavWidth>
          <div className="flex flex-col justify-center text-center items-center min-h-[70vh] px-4 lg:px-0">
            ...
            <Typography className="mb-8">
              Nextwebs is a home for passionate software enineering and web development. The goal is to build a connected world and make it
              a better place. Let's build the future together.
            </Typography>
